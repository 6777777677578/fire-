...
# ---------------------------
TOKENS = [
    "8339813168:AAG-La33vm7tbI2b1HeYjcIJUhLX0H0x2Ck",
    "YOUR_BOT_TOKEN_2",
    "YOUR_BOT_TOKEN_3",
    "YOUR_BOT_TOKEN_4",
    "YOUR_BOT_TOKEN_5",
...
# Put your main admin / owner Telegram ID here (from /myid)
OWNER_ID = 8215404055
...
# GLOBAL STATE
# ---------------------------
# Load SUDO users and always ensure OWNER_ID is included
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("💗 Welcome to Fire Drop Bot!\nUse /help to see all commands.")
